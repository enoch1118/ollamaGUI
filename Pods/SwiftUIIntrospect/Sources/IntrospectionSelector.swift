    ...
    public struct IntrospectionSelector<Target: PlatformEntity> {
        ...
        @_spi(Advanced)
        public static func from<Entry: PlatformEntity>(_: Entry.Type, selector: @escaping (Entry) -> Target?) -> Self {
            .init(
    ...
    extension PlatformViewController {
        func `as`<Base: PlatformEntity>(_: Base.Type) -> (any PlatformEntity)? {
