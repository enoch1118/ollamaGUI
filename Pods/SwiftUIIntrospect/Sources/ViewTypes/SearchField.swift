    ...
    public extension IntrospectableViewType where Self == SearchFieldType {
        static var searchField: Self { .init() }
    }

    #if canImport(UIKit)
        public extension iOSViewVersion<SearchFieldType, UISearchBar> {
        ...
        public extension tvOSViewVersion<SearchFieldType, UISearchBar> {
