    ...
    #if !os(macOS)
        public extension IntrospectableViewType where Self == FullScreenCoverType {
            static var fullScreenCover: Self { .init() }
        }

        #if canImport(UIKit)
            public extension iOSViewVersion<FullScreenCoverType, UIPresentationController> {
            ...
            public extension tvOSViewVersion<FullScreenCoverType, UIPresentationController> {
