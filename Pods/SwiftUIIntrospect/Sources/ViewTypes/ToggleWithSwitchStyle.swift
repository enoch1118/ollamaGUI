    ...
    public struct ToggleWithSwitchStyleType: IntrospectableViewType {
        ...
        public extension IntrospectableViewType where Self == ToggleWithSwitchStyleType {
            static func toggle(style _: Self.Style) -> Self { .init() }
        }

        #if canImport(UIKit)
            public extension iOSViewVersion<ToggleWithSwitchStyleType, UISwitch> {
            ...
            public extension macOSViewVersion<ToggleWithSwitchStyleType, NSSwitch> {
