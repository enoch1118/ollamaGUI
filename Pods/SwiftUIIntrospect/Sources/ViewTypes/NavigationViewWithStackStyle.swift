    ...
    public extension IntrospectableViewType where Self == NavigationViewWithStackStyleType {
        static func navigationView(style _: Self.Style) -> Self { .init() }
    }

    #if canImport(UIKit)
        public extension iOSViewVersion<NavigationViewWithStackStyleType, UINavigationController> {
        ...
        public extension tvOSViewVersion<NavigationViewWithStackStyleType, UINavigationController> {
            static let v13 = Self(for: .v13, selector: selector)
            static let v14 = Self(for: .v14, selector: selector)
            static let v15 = Self(for: .v15, selector: selector)
            static let v16 = Self(for: .v16, selector: selector)
