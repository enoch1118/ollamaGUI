    ...
    public extension IntrospectableViewType where Self == WindowType {
        static var window: Self { .init() }
    }

    #if canImport(UIKit)
        public extension iOSViewVersion<WindowType, UIWindow> {
        ...
        public extension tvOSViewVersion<WindowType, UIWindow> {
            static let v13 = Self(for: .v13, selector: selector)
            static let v14 = Self(for: .v14, selector: selector)
            static let v15 = Self(for: .v15, selector: selector)
            static let v16 = Self(for: .v16, selector: selector)
        ...
        public extension macOSViewVersion<WindowType, NSWindow> {
            static let v10_15 = Self(for: .v10_15, selector: selector)
            static let v11 = Self(for: .v11, selector: selector)
            static let v12 = Self(for: .v12, selector: selector)
            static let v13 = Self(for: .v13, selector: selector)
            static let v14 = Self(for: .v14, selector: selector)
