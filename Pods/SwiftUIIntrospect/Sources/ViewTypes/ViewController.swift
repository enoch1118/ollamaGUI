    ...
    public extension IntrospectableViewType where Self == ViewControllerType {
        static var viewController: Self { .init() }
    }

    #if canImport(UIKit)
        public extension iOSViewVersion<ViewControllerType, UIViewController> {
        ...
        public extension tvOSViewVersion<ViewControllerType, UIViewController> {
            static let v13 = Self(for: .v13)
            static let v14 = Self(for: .v14)
            static let v15 = Self(for: .v15)
            static let v16 = Self(for: .v16)
        ...
        public extension visionOSViewVersion<ViewControllerType, UIViewController> {
