    ...
    #if !os(tvOS)
        public extension IntrospectableViewType where Self == TableType {
            static var table: Self { .init() }
        }

        #if canImport(UIKit)
            public extension iOSViewVersion<TableType, UICollectionView> {
            ...
            public extension visionOSViewVersion<TableType, UICollectionView> {
                static let v1 = Self(for: .v1)
            }

        #elseif canImport(AppKit)
            public extension macOSViewVersion<TableType, NSTableView> {
