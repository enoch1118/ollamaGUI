    ...
    public struct MapType: IntrospectableViewType {}
        ...
        public extension IntrospectableViewType where Self == MapType {
            static var map: Self { .init() }
        }

        public extension iOSViewVersion<MapType, MKMapView> {
        ...
        public extension tvOSViewVersion<MapType, MKMapView> {
        ...
        public extension macOSViewVersion<MapType, MKMapView> {
        ...
        public extension visionOSViewVersion<MapType, MKMapView> {
