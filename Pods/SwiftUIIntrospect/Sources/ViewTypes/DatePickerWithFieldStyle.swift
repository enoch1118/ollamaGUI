    ...
    public struct DatePickerWithFieldStyleType: IntrospectableViewType {
        ...
        public extension IntrospectableViewType where Self == DatePickerWithFieldStyleType {
            static func datePicker(style _: Self.Style) -> Self { .init() }
        }

        #if canImport(AppKit) && !targetEnvironment(macCatalyst)
            public extension macOSViewVersion<DatePickerWithFieldStyleType, NSDatePicker> {
