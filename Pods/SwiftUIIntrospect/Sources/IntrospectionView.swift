    ...
    struct IntrospectionAnchorView: PlatformViewControllerRepresentable {
        ...
        func makePlatformViewController(context _: Context) -> IntrospectionAnchorPlatformViewController {
            IntrospectionAnchorPlatformViewController(id: id)
        }

        func updatePlatformViewController(_: IntrospectionAnchorPlatformViewController, context _: Context) {}

        static func dismantlePlatformViewController(_: IntrospectionAnchorPlatformViewController, coordinator _: Coordinator) {}
    }
    ...
    struct IntrospectionView<Target: PlatformEntity>: PlatformViewControllerRepresentable {
        ...
        static func dismantlePlatformViewController(_ controller: IntrospectionPlatformViewController, coordinator _: Coordinator) {
            controller.handler = nil
        }
    }
